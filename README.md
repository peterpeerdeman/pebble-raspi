...
building/installing:
```
docker run --rm -it \                                            [±master ●●]
-v ~/development/pebble-raspi-native/:/pebble/ \
bboehmke/pebble-dev \
sh -c 'pebble build && pebble install --phone=192.168.117.52'
```

logging:
```
docker run --rm -it -v ~/development/pebble-raspi-native/:/pebble/ bboehmke/pebble-dev
pebble logs --phone=192.168.117.52
```

## original pebble-js docs
